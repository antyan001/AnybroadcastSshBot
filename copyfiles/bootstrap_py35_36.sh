...
# python 35 install
ln -s /opt/cloudera/parcels/PYENV.ZNO0059623792-3.5.pyenv.p0.2/bin/python3.5 /home/$USER//bin/python35
...
ln -s /opt/cloudera/parcels/PYENV.ZNO0059623792-3.5.pyenv.p0.2/bin/jupyter-notebook /home/$USER/bin/jupyter_notebook35
ln -s /opt/cloudera/parcels/PYENV.ZNO0059623792-3.5.pyenv.p0.2/bin/jupyter /home/$USER/bin/jupyter35

# python 36 install
ln -s /opt/cloudera/parcels/PYENV.GPUAI-3.6.pyenv.p0.2/bin/python3.6 /home/$USER//bin/python36
ln -s /opt/cloudera/parcels/PYENV.GPUAI-3.6.pyenv.p0.2/bin/ipython /home/$USER//bin/ipython36
ln -s /opt/cloudera/parcels/PYENV.GPUAI-3.6.pyenv.p0.2/bin/pip /home/$USER/bin/pip36
ln -s /opt/cloudera/parcels/PYENV.GPUAI-3.6.pyenv.p0.2/bin/jupyter-notebook /home/$USER/bin/jupyter_notebook36
ln -s /opt/cloudera/parcels/PYENV.GPUAI-3.6.pyenv.p0.2/bin/jupyter /home/$USER/bin/jupyter36
