...
class Loader(object):
    ...
    def _corpora_iter(self, df, num_partitions=3):
    ...
    def upload_csv(self, table_name, path='/data/data.csv', iskra='iskra4', password='iskraurskb!2018',
